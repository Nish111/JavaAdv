...
public class MyListener implements HttpSessionListener, HttpSessionAttributeListener {
    ...
    public void attributeAdded(HttpSessionBindingEvent arg0)  { 
    	System.out.println("From Listener key with " + arg0.getName() + " and value is "
    			+ arg0.getValue() + " added successfully");
    }
    ...
    public void attributeRemoved(HttpSessionBindingEvent arg0)  { 
    	System.out.println("From Listener key with " + arg0.getName() + " and value is "
    			+ arg0.getValue() + " removed successfully");
    }
    ...
    public void attributeReplaced(HttpSessionBindingEvent arg0)  { 
    	System.out.println("From Listener key with " + arg0.getName() + " and value is "
    			+ arg0.getValue() + " modified successfully");
    }
